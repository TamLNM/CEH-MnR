...
<head>
    ...
    <script src="<?=base_url('assets/js/mnr.js');?>"></script>
    ...
    <script type="text/javascript" src="<?=base_url('assets/vendors/bootstrap-select/dist/js/bootstrap-select.min.js');?>"></script>
    ...
    <script type="text/javascript">
        // var socket = io.connect('http://salan.cehsoft.com');
    </script>
    <script>
        var isTouch = (('ontouchstart' in window) || (navigator.msMaxTouchPoints > 0));
        var evClick=isTouch?"tap":"click";
    </script>
    <style>
        #user_fullname {
        ...
        @media (max-width: 960px) and (orientation: landscape) {
            ...
            .app-title::after{
                content: 'GIÁM ĐỊNH SỬA CHỮA CONTAINER';
                font-size: 3vw;
            }
            #right-out {
                font-size: 1.75vw;
        ...
        .content-wrapper{
            ...
            background: none;/*url("<?=base_url('assets/img/register-bgr-3.jpg');?>");*/
        ...
        .ibox .ibox-body {
            padding: 2.5px 17.5px 2.5px!important;
        }
        ...
        <header class="header">
            <div class="page-brand">
                <a href="<?=site_url(md5('home'));?>" style="margin: auto">
                    <span class="brand brand-font">M&R</span>
                    <span class="brand-mini brand-font"></span>
                </a>
            </div>
            <div class="flexbox flex-1">
                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li>
                        <div class="ibox-head">
                            <h3 class="font-weight-bold text-center pl-2 app-title" style="font-size: 23px!important;"></h3>
                        </div>
                    </li>
                </ul>
                ...
                <ul id="right-out" class="nav navbar-toolbar" style="font-size: 12px;">
        ...
        <nav class="page-sidebar" id="sidebar" >
            <div id="sidebar-collapse">
                <ul class="side-menu metismenu">
                    <li>
                        <a href="<?=site_url(md5('home'));?>"><i class="sidebar-item-icon la la-home" style="padding-top: 2px;"></i>
                    ...
                    <?php foreach($menus as $menu) {    
                        if(count($menu['submenu']) > 0) { ?>
                            <li id="<?=$menu['MenuID'];?>">
                                <a href="javascript:;">
                                    <i class="sidebar-item-icon la la-table" style="padding-top: 2px;"></i>
                                ...
                                <?php foreach($menu['submenu'] as $sub) { ?>
                                    <li>
                                        <a href="<?=site_url(md5($menu['MenuID']) . '/' . md5($sub['MenuID']));?>" title="<?=$sub['MenuName'];?>" style="padding-left: 2.2em"><i class="sidebar-item-icon la la-<?=$sub['MenuIcon'];?>"></i>
                                            <span class="nav-label labelXXX"><?=$sub['MenuName'];?></span>
                                        </a>
                                    </li>
                                <?php } ?>
                                </ul>
