...
<div class="row">
	<div class="col-xl-12">
		<div class="ibox collapsible-box">
			<div class="ibox-head">
				<div class="ibox-title">BỘ PHẬN CONTAINER</div>
					...
					<div id="tablecontent">
						<table id="contenttable" class="table table-striped display nowrap" cellspacing="0" style="width: 99.8%">
							...
							<tr>
								...
								<th col-name="YARD_ID">Mã Cảng/ Depot</th>
								<th col-name="COMP_ID">Mã bộ phận cont</th>
								<th col-name="COMP_NAME_EN">Tên bộ phận cont (Tiếng Anh)</th>
								<th col-name="COMP_NAME_VN">Tên bộ phận cont (Tiếng Việt)</th>
								<th col-name="ASSEMBLY">ASSEMBLY</th>
								<th col-name="SIDE">SIDE</th>
								<th col-name="CONT_TYPE">Loại container</th>
							</tr>
							</thead>
							<tbody>
							</tbody>
...
<script type="text/javascript">
	$(document).ready(function () {
		var _columns 	= ["STT", "ROWGUID", "YARD_ID", "COMP_ID", "COMP_NAME_EN", "COMP_NAME_VN", "ASSEMBLY", "SIDE", "CONT_TYPE"],
			tbl 		= $('#contenttable'),
			parentMenuList 	= {};
		...
		var dataTbl = tbl.newDataTable({
			...
			columnDefs: [
				...
				{ className: "text-center", targets: _columns.getIndexs(["YARD_ID", "COMP_ID", "COMP_NAME_EN", "COMP_NAME_VN", "ASSEMBLY", "SIDE", "CONT_TYPE"])},
