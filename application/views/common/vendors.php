...
<div class="row">
	<div class="col-xl-12">
		<div class="ibox collapsible-box">
			<div class="ibox-head">
				<div class="ibox-title">ĐƠN VỊ SỬA CHỮA</div>
					...
					<div id="tablecontent">
						<table id="contenttable" class="table table-striped display nowrap" cellspacing="0" style="width: 99.8%">
							...
							<tr>
								...
								<th col-name="VENDOR_ID">Mã đơn vị sửa chữa</th>
								<th col-name="VENDOR_NAME">Tên đơn vị sửa chữa</th>
								<th col-name="IS_ALLOWED">Được sử dụng</th>
							</tr>
							</thead>
							<tbody>
							</tbody>
...
<script type="text/javascript">
	$(document).ready(function () {
		var _columns 	= ["STT", "ROWGUID", "YARD_ID", "VENDOR_ID", "VENDOR_NAME", "IS_ALLOWED"],
			tbl 		= $('#contenttable'),
			parentMenuList 	= {};
		...
		var dataTbl = tbl.newDataTable({
			...
			columnDefs: [
				...
				{ className: "text-center", targets: _columns.getIndexs(["YARD_ID", "VENDOR_ID", "VENDOR_NAME", "IS_ALLOWED"])},
