...
<div class="row">
	<div class="col-xl-12">
		<div class="ibox collapsible-box">
			<div class="ibox-head">
				<div class="ibox-title">HƯ HỎNG CONTAINER</div>
					...
					<div id="tablecontent">
						<table id="contenttable" class="table table-striped display nowrap" cellspacing="0" style="width: 99.8%">
							...
							<tr>
								...
								<th col-name="DAM_NAME_EN">Tên hư hỏng Tiếng Anh</th>
								<th col-name="DAM_NAME_VN">Tên hư hỏng Tiếng Việt</th>
							</tr>
							</thead>
							<tbody>
							</tbody>
...
<script type="text/javascript">
	$(document).ready(function () {
		var _columns 	= ["STT", "ROWGUID", "YARD_ID", "DAM_ID", "DAM_NAME_EN", "DAM_NAME_VN"],
			tbl 		= $('#contenttable'),
			parentMenuList 	= {};
		...
		var dataTbl = tbl.newDataTable({
			...
			columnDefs: [
				...
				{ className: "text-center", targets: _columns.getIndexs(["YARD_ID", "DAM_ID", "DAM_NAME_EN", "DAM_NAME_VN"])},
