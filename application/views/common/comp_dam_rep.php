...
<div class="row">
	<div class="col-xl-12">
		<div class="ibox collapsible-box">
			<div class="ibox-head">
				<div class="ibox-title">COMP - DAM - REP</div>
					...
					<div id="tablecontent">
						<table id="contenttable" class="table table-striped display nowrap" cellspacing="0" style="width: 99.8%">
							...
							<tr>
								...
								<th col-name="COMP_ID">Mã bộ phận</th>
								<th col-name="DAM_ID">Mã hư hỏng</th>
								<th col-name="REP_ID">Mã sửa chữa</th>
								<th col-name="NAME_EN">Diễn giải (Tiếng Anh)</th>
								<th col-name="NAME_VN">Diễn giải (Tiếng Việt)</th>
							</tr>
							</thead>
							<tbody>
							</tbody>
...
<script type="text/javascript">
	$(document).ready(function () {
		var _columns 	= ["STT", "ROWGUID", "YARD_ID", "COMP_ID", "DAM_ID", "REP_ID", "NAME_EN", "NAME_VN"],
			tbl 		= $('#contenttable'),
			parentMenuList 	= {};
		...
		var dataTbl = tbl.newDataTable({
			...
			columnDefs: [
				...
				{ className: "text-center", targets: _columns.getIndexs(["YARD_ID", "COMP_ID", "DAM_ID", "REP_ID", "NAME_EN", "NAME_VN"])},
