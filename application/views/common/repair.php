...
<div class="row">
	<div class="col-xl-12">
		<div class="ibox collapsible-box">
			<div class="ibox-head">
				<div class="ibox-title">SỬA CHỮA CONTAINER</div>
					...
					<div id="tablecontent">
						<table id="contenttable" class="table table-striped display nowrap" cellspacing="0" style="width: 99.8%">
							...
							<tr>
								...
								<th col-name="REP_NAME_EN">Diễn giải (tiếng Anh)</th>
								<th col-name="REP_NAME_VN">Diễn giải (tiếng Việt)</th>
							</tr>
							</thead>
							<tbody>
							</tbody>
...
<script type="text/javascript">
	$(document).ready(function () {
		var _columns 	= ["STT", "ROWGUID", "YARD_ID", "REP_ID", "REP_NAME_EN", "REP_NAME_VN"],
			tbl 		= $('#contenttable'),
			parentMenuList 	= {};
		...
		var dataTbl = tbl.newDataTable({
			...
			columnDefs: [
				...
				{ className: "text-center", targets: _columns.getIndexs(["YARD_ID", "REP_ID", "REP_NAME_EN", "REP_NAME_VN"])},
