...
<style>
    ...
    .scanfcode_googel_cnt:hover,input.google_in:focus
    {
            ...
            <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 col-centered">
                <div class="ibox-body p-3 flex-pdtop search-box">
                    ...
                    <ul class="nav nav-tabs tabs-line tabs-line-5x tabs-line-danger" style="font-size: 14px">
                        <li class="nav-item">
                            <a class="nav-link active" href="#tab-12-1" data-value="cont" data-toggle="tab"><i class="mr-2"></i>Số VIN</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <h4 class="hiden-input cont-error col-form-label text-center pb-4 mt-5"><span style="color: red;">Số VIN không tồn tại ! Vui lòng thử lại</span></h4>
                ...
                <div class="ibox-body p-0 mt-2">
                    ...
                    <div class="row border-e p-2 hiden-input pb-2 mb-2" id="cont-details">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 col-centered">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label">POD</label>
                                <label id="POD" class="col-sm-7 col-form-label font-bold" >22GP</label>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label">FPOD</label>
                                <label id="FPOD" class="col-sm-7 col-form-label font-bold" >22GP</label>
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 col-centered">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label">Hãng tàu</label>
                                <label id="OprID" class="col-sm-7 col-form-label font-bold" >22GP</label>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label">Trọng lượng</label>
                                <label id="CMDWeight" class="col-sm-7 col-form-label font-bold" >22GP</label>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label">Nguy hiểm</label>
...
//								$('ul.pagination').append(pagenext);
                        ...
                        if(!data.results || data.results.length == 0){
                            ...
                            if(data.results.length > 0) {
                                ...
                                for (i = 0; i < data.results.length; i++) {
                                    rows.push([
                                        (i+1)
                                        , data.results[i].CntrNo
                                        , data.results[i].OprID
                                        , data.results[i].LocalSZPT
                                        , data.results[i].cLocation
                                        , getDateTime(data.results[i].DateIn)
                                        , getDateTime(data.results[i].DateOut)
                                        , data.results[i].CMStatus == 'B' ? 'Trên Tàu' : (data.results[i].CMStatus == 'I' ? 'Đang vào bãi' : ((data.results[i].CMStatus == 'S' ? 'Trên bãi' : 'Đã giao ra')))
                                    ]);
                                }
                                $('#bill-book-details').DataTable( {
                                    data: rows,
        ...
        function loadContInfo(idx){
            ...
            if(critem){
                ...
                $('label#IsLocal').html((critem.Status == 'F') ? "Ngoại" : "Nội");
                $('label#OOG').html((critem.OOG_TOP == 0 ? "0": critem.OOG_TOP) + '/' + (critem.OOG_LEFT == 0 ? "0": critem.OOG_LEFT) + '/' + (critem.OOG_RIGHT == 0 ? "0": critem.OOG_RIGHT) + '/'
                    + (critem.OOG_BACK == 0 ? "0": critem.OOG_BACK) + '/' + (critem.OOG_FRONT == 0 ? "0": critem.OOG_FRONT));
